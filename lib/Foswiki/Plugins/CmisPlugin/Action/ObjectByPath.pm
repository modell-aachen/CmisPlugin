...
package Foswiki::Plugins::CmisPlugin::Action::ObjectByPath;

=begin TML

---+ package CmisPlugin::Action::ObjectByPath

This implements action="querybypath" of the %CMIS macro.
...
sub doit {
  ...
  my $obj = $repo->getObjectByPath($params->{path});
